...
class OCC_DukeMTMCreID_mini(BaseImageDataset):
    """
    DukeMTMCreID
    Reference:
    ...
    # cameras: 8
    """
    dataset_dir = 'Occluded_Duke_mini'

    def __init__(self, root='./data', verbose=True, pid_begin=0, **kwargs):
        super(OCC_DukeMTMCreID_mini, self).__init__()
    ...
    def _download_data(self):
        ...
        print("Downloading DukeMTMCreID dataset")
