...
from .occ_duke_mini import OCC_DukeMTMCreID_mini
...
__factory = {
    ...
    'veri': VeRi,
    'VehicleID': VehicleID,
    'occ_duke_mini': OCC_DukeMTMCreID_mini
}  # 定义一个包含所有数据集的字典
...
def  make_dataloader(cfg):
    ...
    #     T.ColorJitter(brightness=0.1, contrast=0.1, saturation=0.1, hue=0),                  # 遮挡增强代码！！
    #     T.Resize(cfg.INPUT.SIZE_TRAIN, interpolation=3),
    #     T.RandomHorizontalFlip(p=cfg.INPUT.PROB),
    #     T.Pad(cfg.INPUT.PADDING),
    #     T.RandomCrop(cfg.INPUT.SIZE_TRAIN),
    ...
    # train_set = ImageDataset(dataset.train, train_transforms1, train_transforms2, train_normalize)
