...
if __name__ == "__main__":
    ...
    Test_state = torch.load(cfg.TEST.WEIGHT)
    model.load_state_dict(Test_state['model_state_dict'])


    # show_network(model)
    # visualized_layer = 'base.blocks.4.mlp'
    # display = Display(model, visualized_layer, img_size=(256, 128))
    # from PIL import Image
    #
    # image = Image.open('0038_c1_f0058489.jpg').resize((256, 128))
    # display.save(image)
